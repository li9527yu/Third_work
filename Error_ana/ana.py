    ...
    for i in tqdm(range(len(dataset)), desc="Single-sample Testing"):
        ...
        (input_ids,input_multi_ids,input_attention_mask,input_multi_attention_mask,\
            input_hidden_states,input_pooler_outputs,\
                labels_text,labels,senti_label,relation_label,raw_meta) = sample
        ...
        meta_records.append({
            ...
            "text_sentiment":raw_meta["textual_clues_parsed"]["polarity"],
            "text_confidence":raw_meta["textual_clues_parsed"]["confidence"],
