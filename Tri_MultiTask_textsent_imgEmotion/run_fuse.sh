...
# 12-15: 多任务: 将双路中的文本分支，转变为文本情感预测任务，更换Gemini的img emotion
...
do
    ...
    --output_dir /data/lzy1211/code/pretrain/outputs/mutltiTask_textSenti_changeGenerate/${dataset}/${seed} \
    --BATCH_SIZE 16 \
    --seed ${seed} \
    --EPOCHS 20 \
    --LEARNING_RATE 5e-5 \
...
# 1127:在不考虑相关性的情况下直接使用情感线索，同时加入主观性分类的多任务
# for dataset in "twitter2015"   
# do
#     for seed in "24"
#     do
...
#     --img_feat_dir /data/lzy1211/code/A2II/instructBLIP/img_data \
#     --output_dir /data/lzy1211/code/pretrain/outputs/mtl_subject/${dataset}/${seed} \
#     --BATCH_SIZE 8 \
#     --seed ${seed} \
#     --EPOCHS 20 \
#     --LEARNING_RATE 2e-5 \
