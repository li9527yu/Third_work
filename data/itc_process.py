...
def build_eccl_dataset(data_path, save_path):
    relation_map={
        "the semantic relevance is relevant, the emotional relevance is relevant":1,
        "the semantic relevance is relevant, the emotional relevance is irrelevant":2,
...
# 
        ...
        parsed = item.get("textual_clues_parsed", {})
        text_em = parsed.get("polarity", "")
        img_em = item.get("img_clue", "")
        relation_s = relation_map[item.get("relation")]
